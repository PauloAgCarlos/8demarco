...
@section('conteudo')
  ...
  <p> <a href="declaracoes.html"> <input type="submit" value="DECLARAÇÕES" class="btn"></a></p>
    ...
    <div class="container">
        <p><label for="cNumeroSGA"></label> <input type="number" name="tNumeroSGA" id="cNumeroSGA" placeholder="Número de SGA"></p>
    </div>
