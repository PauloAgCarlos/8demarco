      ...
      <div class="row">
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="light white-text"> O sistema de gestão académica fornecido pela D3V-T3CN0, oferece vantagens incríveis dentre elas as seguintes: <br>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p><h4 class="center white-text" >D3V-T3CN0</h4></p>
          </div>
        </div>
      </div>
